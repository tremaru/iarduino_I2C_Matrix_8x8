...
void setup(){                                                    //
    ...
    for(int i=0; i<k; i++){                                      // Проходим по всем дисплеям ...
        disp[i].begin(&sWire);                                   // Инициируем работу с очередной LED матрицей 8x8, указав ссылку на объект для работы с шиной I2C на которой находится LED матрица (по умолчанию &Wire).
