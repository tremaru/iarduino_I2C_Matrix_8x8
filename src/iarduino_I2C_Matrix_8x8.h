...
#endif																																	//
																																		//
#include		"iarduino_I2C_Matrix_8x8_I2C.h"																							//	Подключаем библиотеку выбора реализации шины I2C.
																																		//
...
class iarduino_I2C_Matrix_8x8{																											//
	...
	/**	Пользовательские функции **/																									//
		...
		void				print			(const char	  i, unsigned int j=0	){ _printStr(String (i),uint8_t(j));}					//	Определяем функцию вывода символа или бегущей строки				(Параметры: символ/текст,  [функция анимации появления]).
		void				print			(char*        i, unsigned int j=0	){ _printStr(String (i),uint8_t(j));}					//	Определяем функцию вывода символа или бегущей строки				(Параметры: символ/текст,  [функция анимации появления]).
		void				print			(const char*  i, unsigned int j=0	){ _printStr(String (i),uint8_t(j));}					//	Определяем функцию вывода символа или бегущей строки				(Параметры: символ/текст,  [функция анимации появления]).
		void				print			(String       i, unsigned int j=0	){ _printStr(        i ,uint8_t(j));}					//	Определяем функцию вывода символа или бегущей строки				(Параметры: символ/текст,  [функция анимации появления]).
		void				print			(int32_t      i, unsigned int j=0	){ _printNum(uint8_t(i),uint8_t(j));}					//	Определяем функцию вывода цифры										(Параметры: цифра,         [функция анимации появления]).
		void				print			(uint32_t     i, unsigned int j=0	){ _printNum(uint8_t(i),uint8_t(j));}					//	Определяем функцию вывода цифры										(Параметры: цифра,         [функция анимации появления]).
#ifdef RENESAS_CORTEX_M4																												//	Для плат Arduino UNO R4												(По состоянию на февраль 2024)
		void				print			(int          i, unsigned int j=0	){ _printNum(uint8_t(i),uint8_t(j));}					//	Определяем функцию вывода цифры										(Параметры: цифра,         [функция анимации появления]).
		void				print			(unsigned int i, unsigned int j=0	){ _printNum(uint8_t(i),uint8_t(j));}					//	Определяем функцию вывода цифры										(Параметры: цифра,         [функция анимации появления]).
#else																																	//	Для отальных плат Arduino ESP RP									(По состоянию на февраль 2024)
	...
	/**	Внутренние функции **/																											//
		bool				_begin			(void								);														//	Объявляем  функцию инициализации дисплея							(Параметр:  отсутствует).
