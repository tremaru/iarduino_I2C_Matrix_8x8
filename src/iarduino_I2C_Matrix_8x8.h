...
#define			DEF_MODEL				0x08																							//	Идентификатор модели - константа.
...
#define			REG_SAVE_AS				0x19																							//	Адрес регистра позволяющего заменить изображение символа в таблице символов на текущее изображение экрана.
#define			REG_SYMBOL_INPUT		0x1A																							//	Адрес регистра позволяющего вывести изображение символа по его коду.
#define			REG_TEXT_INPUT			0x1B																							//	Адрес регистра позволяющего дописать текст бегущей строки.
#define			REG_STEP_LEN			0x1C																							//	Адрес регистра позволяющего установить бегущую строку в указанную позицию.
#define			REG_TIME_STEP			0x1E																							//	Адрес регистра содержащего время затрачиваемое на один шаг автопрокрутки бегущей строки в сотых долях секунд.
#define			REG_TIME_PAUSE			0x1F																							//	Адрес регистра содержащего время паузы до повторной автопрокрутки всей бегущей строки в десятых долях секунд.
#define			REG_TIME_START			0x20																							//	Адрес регистра содержащего время простоя автопрокрутки на первом    символе текста в сотых долях секунд.
#define			REG_TIME_STOP			0x21																							//	Адрес регистра содержащего время простоя автопрокрутки на последнем символе текста в сотых долях секунд.
#define			REG_FUNCTIONS			0x22																							//	Адрес регистра позволяющего выполнить функцию анимации по её номеру.
